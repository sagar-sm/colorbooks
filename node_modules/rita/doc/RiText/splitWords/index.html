				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Splits the object into an array of RiTexts, one per word tokenized with the supplied pattern. Regular expressions will be used if the 1st argument is a regular expression, otherwise only generic string-matching is used (special regex characaters are escaped)</td>
						</tr>
